...
raw_data_path = "/content/gdrive/My Drive/Intern/beach_image"
train_save_path = "/content/gdrive/My Drive/Intern/train"
test_save_path = "/content/gdrive/My Drive/Intern/test"
